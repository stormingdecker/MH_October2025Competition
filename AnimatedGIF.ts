...
const tex1 = new Asset(BigInt("1327298762122946"))
const tex2 = new Asset(BigInt("1361684335606841"))
const tex3 = new Asset(BigInt("1877490752846322"))
const tex4 = new Asset(BigInt("1877490752846322"))
...
class AnimatedGIF extends Component<typeof AnimatedGIF> {
  ...
  start() {
    ...
    this.addTextureToArray(tex1);
    this.addTextureToArray(tex2);
    this.addTextureToArray(tex3);
    this.addTextureToArray(tex4);
